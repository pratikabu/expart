 ...
 * @author Blue
 */
public class PaymentModeView extends javax.swing.JDialog {
    private ArrayList<Integer> ids = new ArrayList<Integer>();

    /** Creates new form BalanceView */
    public PaymentModeView(java.awt.Frame parent) {
        super(parent, false);
        initComponents();
        ...
        if (row != -1) {
            ...
            try{
                if(rset.next()){
                    ...
                    if(count > 0)
                        JOptionPane.showMessageDialog(this, "You cannot delete this payment mode as there are\n"
                                + "transactions which are this payment mode.\n"
